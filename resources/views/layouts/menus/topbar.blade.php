            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="al"
                            title="Shqip">
                            <img src="{{ asset('assets/images/flags/al.svg') }}" alt="user-image"
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('plugins.index') }}" class="btn btn-sm btn-soft-info"> View All
                                        Apps
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header"><span data-key="t-Welcome">{{ _lang('Welcome') }}</span>
                            {{ Auth::user()->name }}!</h6>


                        <a class="dropdown-item" href="{{ route('profile.index') }}">
                            <i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                            <span class="align-middle" data-key="t-Profile">{{ _lang('My Profile') }}</span>
                        </a>

                        <a class="dropdown-item" href="{{ route('profile.edit') }}">
                            <i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i>
                            <span class="align-middle">{{ _lang('Profile Settings') }}</span>
                        </a>

                        <a class="dropdown-item" href="{{ route('profile.change_password') }}">
                            <i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i>
                            <span class="align-middle">{{ _lang('Change Password') }}</span>
                        </a>

                        @if (Auth::user()->user_type == 'admin')
                            <a class="dropdown-item" href="{{ route('settings.update_settings') }}">
                                <i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i>
                                <span class="align-middle">{{ _lang('System Settings') }}</span>
                            </a>
                        @endif
                        ...
                        <a class="dropdown-item" href="apps-chat.html"><i
                            ...
                            <span class="align-middle" data-key="t-Messages">Messages</span></a>
